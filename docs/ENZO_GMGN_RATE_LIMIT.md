...
python3 tests/test_gmgn_cli_compat.py     # 135 checks, incl. §11 reset_at/fail-fast, §12 --interval, §13 kline, §14 trenches --type + data.pump
...
Full suite: **842 checks, 0 failures** across 20 suites (`bash` the list in the
