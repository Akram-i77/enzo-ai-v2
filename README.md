...
عشرون حزمة، **868 تحقّقاً**، كلها تعمل بلا إعداد وبلا شبكة وبلا محفظة حقيقية:

```bash
python3 tests/test_dashboard_e2e.py        # 129  اللوحة: خادم حي + نقر كل زر في DOM
python3 tests/test_gmgn_cli_compat.py      # 153  توافق gmgn-cli v1.6.1: المسار الكامل + الحظر + kline + فئات trenches + نوافذ الزخم
